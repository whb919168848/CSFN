...
class ImageDataset(data.Dataset):
    def __init__(self, args ,phase=None):
        ...
        self.args =args
        self.load_class_path = '/home/dell/data/code/whb/SAT-main(CLIP)/Model/cub_efficientnetb7.json'
        self.root = '/home/dell/data/dataset/CUB_200_2011'
        # self.root = '/home/dell/data/dataset/CUB_200_2011/split'
        self.test_txt_path = self.root + '/' + 'test_list.txt'
        self.test_gt_path = self.root + '/' + 'test_bounding_box.txt'
        # self.test_txt_path = self.root + '/' + 'test4.txt'
        # self.test_gt_path = self.root + '/' + 'test_box4.txt'
        ...
        # self.name2result = np.load('/home/dell/data/code/whb/CSFN/cub_test4.npy', allow_pickle=True).item()
