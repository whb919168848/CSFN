...
class ImageDataset(data.Dataset):
    def __init__(self, args, phase=None):
        ...
        self.args =args
        # self.load_class_path = '/home/dell/data/code/whb/pretrained/imagenet_conformer-base-p16_3rdparty_8xb128_in1k.json'
        self.load_class_path = '/home/dell/data/code/whb/pretrained/imagenet_efficientnet-b7_3rdparty_8xb32-aa-advprop_in1k.json'
        self.root = '/home/dell/data/dataset/ImageNet_2012/'
        self.test_txt_path = '/home/dell/data/code/whb/SAT-main/Data/ILSVRC/val_list.txt'
        self.test_gt_path = '/home/dell/data/code/whb/SAT-main/Data/ILSVRC/val_gt.txt'
        ...
        if self.phase == 'train':
            ...
            self.img_dataset = ImageFolder(os.path.join(self.root, 'val1'))
            self.transform = transforms.Compose([
                transforms.Resize((self.resize_size, self.resize_size)),
    ...
    def __getitem__(self, index):
        ...
        if self.phase == 'train':
            ...
            name = path.split('val1/')[1][0:-5]
            path = path.replace('val1', 'val')
            path = path.replace('/', '\\')
